...
class IMDbText(HuggingFaceDatasetText):
    """
    ...
    def splits(cls, *args, **kwargs):
        return super().splits(dataset_name="imdb", *args, **kwargs)
...
if __name__ == "__main__":
    ...
    train_set, test_set, val_set = IMDbText.splits(tokenizer)
    print("train size=", len(train_set), train_set.classes)
